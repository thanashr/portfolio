			...
			<Container fluid= {true}>							
				...
				<Row className = "text-justify ml-2">
					<Col md = {7} sm={7} className = "edu_col">
							...
							<p className=" ml-5 mt-2 lead sociallink font-weight-LIGHT text-justify"><small>Volunteered at the 
					...
					<Col md = {7} sm={7} className = "edu_col">
							<p className = "edu ml-2 mt-5  intro  font-weight-LIGHT">Communities</p>
									...
									<li className="skill_list ml-lg-5 mt-0  font-weight-LIGHT"><small>Society of Women Engineers</small> </li>
									<li className="skill_list ml-lg-5 mt-0  font-weight-LIGHT"><small>CodePath</small> </li>
									<li className="skill_list ml-lg-5 mt-0  font-weight-LIGHT"><small> Women Who Code</small> </li>									
								</ul>		
					</Col>
